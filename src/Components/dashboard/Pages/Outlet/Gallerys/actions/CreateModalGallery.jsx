      ...
      <Modal.Body>
        <div className="grid grid-flow-row-dense lg:grid-cols-4 grid-cols-2   gap-3">
          <div className="lg:col-auto col-span-2">
            ...
            <TextInput id="small" type="text" sizing="sm" placeholder="مساخه الوحده" />
          </div>
          <div className="lg:col-auto col-span-2">
            <div className="mb-2 block">
          ...
          <div className="lg:col-auto col-span-2">
            ...
            <TextInput id="small" type="text" sizing="sm" placeholder="عدد الغرف" />
          </div>
          <div className="lg:col-auto col-span-2">
            <div className="mb-2 block">
              <Label htmlFor="small" value="عدد المطابخ" />
            </div>
            <TextInput id="small" type="text" sizing="sm" placeholder="عدد المطابخ" />
          </div>
          <div className="lg:col-auto col-span-2">
            <div className="mb-2 block">
              <Label htmlFor="small" value="عدد البلكونه" />
            </div>
            <TextInput id="small" type="text" sizing="sm" placeholder="عدد اتلبلكونه" />
          </div>
          <div className="lg:col-auto col-span-2">
            <div className="mb-2 block">
              <Label htmlFor="small" value="عدد الصالات" />
            </div>
            <TextInput id="small" type="text" sizing="sm" placeholder="عدد الصالات" />
          </div>
          <div className="lg:col-auto col-span-2">
            <div className="mb-2 block">
