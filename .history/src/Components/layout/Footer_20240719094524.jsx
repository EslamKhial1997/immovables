  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl py-8">
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 px-4">
          <div>
            <h2 className="mb-2 lg:mb-6 text-base lg:text-xl font-ge-dinar-medium text-secondary-100">
              روابط هامة
            </h2>
            <ul className="text-gray-200 dark:text-gray-400">
              <li className="mb-2">
                <a className="text-secondary-200" aria-current="page" href="https://almajdiah.com/projects">المشاريع</a>
              </li>
              <li className="mb-2">
                <a className="text-secondary-200" aria-current="page" href="https://almajdiah.com/rentals">وحدات
                  للإيجار</a>
              </li>
              <li className="mb-2">
                <a className="text-secondary-200" aria-current="page" href="https://almajdiah.com/blog">المدونة</a>
              </li>
              <li className="mb-2">
                <a className="text-secondary-200" aria-current="page" href="https://almajdiah.com/about-us">من نحن</a>
              </li>
              <li className="mb-2">
                <a className="text-secondary-200" aria-current="page" href="https://almajdiah.com/privacy-policy">سياسة
                  الخصوصية</a>
              </li>
              <li className="mb-2">
                <a className="text-secondary-200" aria-current="page"
                  href="https://almajdiah.com/intellectual-property-rights">حقوق الملكية الفكرية</a>
              </li>
              <li className="mb-2">
                <a className="text-secondary-200" aria-current="page" href="https://almajdiah.com/terms">شروط
                  الإستخدام</a>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-full lg:col-span-1">
            ...
            <div className="flex w-full rtl:space-x-reverse space-x-3 text-secondary-200">
    ...
    <div className="sm:flex sm:items-center sm:justify-between bg-black bg-waves">
      <div className="container m-auto text-center py-4">
        <span className="text-sm text-secondary-200">جميع الحقوق محفوظة © <span className="font-acumin-pro">2022</span>
