  ...
  return (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 px-4">
          <div>
            ...
            <ul className="text-gray-200 dark:text-gray-400">
              <li className="mb-2">
                <a className="text-light-200" aria-current="page" href="https://almajdiah.com/projects">المشاريع</a>
              </li>
              <li className="mb-2">
                <a className="text-light-200" aria-current="page" href="https://almajdiah.com/rentals">وحدات
                  للإيجار</a>
              </li>
              <li className="mb-2">
                <a className="text-light-200" aria-current="page" href="https://almajdiah.com/blog">المدونة</a>
              </li>
              <li className="mb-2">
                <a className="text-light-200" aria-current="page" href="https://almajdiah.com/about-us">من نحن</a>
              </li>
              <li className="mb-2">
                <a className="text-light-200" aria-current="page" href="https://almajdiah.com/privacy-policy">سياسة
                  الخصوصية</a>
              </li>
              <li className="mb-2">
                <a className="text-light-200" aria-current="page"
                  href="https://almajdiah.com/intellectual-property-rights">حقوق الملكية الفكرية</a>
              </li>
              <li className="mb-2">
                <a className="text-light-200" aria-current="page" href="https://almajdiah.com/terms">شروط
                  الإستخدام</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              <li className="text-light-200 text-sm font-acumin-pro">
    ...
    <div className="sm:flex sm:items-center sm:justify-between bg-black bg-waves">
      <div className="container m-auto text-center py-4">
        <span className="text-sm text-light-200">جميع الحقوق محفوظة © <span className="font-acumin-pro">2022</span>
