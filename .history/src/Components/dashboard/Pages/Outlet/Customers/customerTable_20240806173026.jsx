      ...
      <Table dir="rtl">
        ...
        <Table.Body className="divide-y text-center">
          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
            ...
            <Table.Cell className="grid grid-cols-2 gap-2"><Button className="bg-red-600">حذف</Button><Button>تعديل</Button></Table.Cell>
          </Table.Row>
          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
              مجهول الهويه
          ...
          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
            ...
            <Table.Cell className="grid grid-cols-2 text-xs gap-2"><Button className="bg-red-600">حذف</Button><Button>تعديل</Button></Table.Cell>
          </Table.Row>
        </Table.Body>
      </Table>
    </div>
