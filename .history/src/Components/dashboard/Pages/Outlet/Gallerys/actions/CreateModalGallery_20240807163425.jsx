...
const CreateModalGallery = () => {
  ...
  return (
    <Modal show={GalleryModel}>
      ...
      ></Modal.Header>
      <Modal.Body>
        <div className="grid grid-flow-row-dense lg:grid-cols-4  md:grid-cols-2 sm:grid-cols-2 grid-cols-2 gap-3">
          <div className="lg:grid-cols-4  md:grid-cols-2 sm:grid-cols-2 grid-cols-2">
