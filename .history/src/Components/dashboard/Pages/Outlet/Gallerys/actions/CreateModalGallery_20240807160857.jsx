      ...
      <Modal.Body>
        <div className="grid grid-flow-row-dense lg:grid-cols-4 grid-cols-1 grid-rows-3 gap-3">
          ...
          <div className="">
           ...
           <div> <Radio id="germany" name="countries" value="Germany" /> <Label htmlFor="small" value="نعم" /></div>
           <div> <Radio id="germany" name="countries" value="Germany" /> <Label htmlFor="small" value="نعم"لا/></div>
