  ...
  return (
    <div className="overflow-x-scroll xl:w-auto lg:w-auto w-screen  h-screen ">
      <div className="p-2 grid grid-cols-4 gap-4">
        <div className="grid grid-cols-2 content-center bg-yellow-400 text-center items-center rounded-lg">
         <span className=""> كل الوحدات</span>
          <FaPlus  className="cursor-pointer bg-white color-yellow-400"/>
        </div>
