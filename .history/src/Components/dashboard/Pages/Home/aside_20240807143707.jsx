  ...
  >
    <Sidebar.Items className="mt-16">
      <Sidebar.ItemGroup>
        ...
        >
          <Sidebar.Item href="#" icon={HiUser}>ادارة العملاء</Sidebar.Item>
          <Sidebar.Item href="#" icon={HiUser} onClick={()=>{dispatch(setOpenCustomerModel(true))}}>اضافه العملاء</Sidebar.Item>
    ...
    <Sidebar.Item href="#">Shipping</Sidebar.Item> */}
        ...
        <Sidebar.Collapse
          ...
          className=" bg-gray-300 "
        >
          <Sidebar.Item href="#">ادارة الكتالوج  <HiArrowSmRight className="mr-2 h-5 w-5" /></Sidebar.Item>
