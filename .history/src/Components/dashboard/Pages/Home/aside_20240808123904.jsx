  ...
  return (
    ...
    <Sidebar.Item href="#">Shipping</Sidebar.Item> */}
          ...
          >
            ...
            <div onClick={()=>{dispatch(setOpenGalleryModel)}} className="grid grid-cols-2 py-2 content-center cursor-pointer bg-gray-200 text-center items-center rounded-lg">
