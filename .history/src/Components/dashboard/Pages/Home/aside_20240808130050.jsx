...
import { setOpenCustomerModel, setOpenGalleryModel } from "../../../store/SharedStore";
  ...
  return (
    ...
    <Sidebar.Item href="#">Shipping</Sidebar.Item> */}
          ...
          >
            ...
            <div onClick={()=>{dispatch(setOpenGalleryModel(true))}} className="grid grid-cols-2 py-2 content-center cursor-pointer bg-gray-200 text-center items-center rounded-lg">
          ...
          >
            ...
            <Sidebar.Item href="#"> <NavLink to={"/dashboard"}>ادارة الصلاحيات</NavLink></Sidebar.Item>
            <div onClick={()=>{dispatch(setOpenGalleryModel(true))}} className="grid grid-cols-2 py-2 content-center cursor-pointer bg-gray-200 text-center items-center rounded-lg">
              <span className="">اضافه صلاحيه</span>
              <span className=" m-auto">
                <FaPlus className="  bg-white text-gray-400 " />
              </span>
            </div>
