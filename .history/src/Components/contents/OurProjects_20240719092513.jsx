                  ...
                  <a class="block mb-2 text-secondary-500" href="https://almajdiah.com/projects/195">
                    <div class="rounded-tl-lg rounded-tr-lg cursor-pointer relative">
                      <img
                        ...
                        alt="الماجدية ريزدنس 156" class="w-full aspect-[5/3] text-blue-700 align-middle object-cover" />
                      <div>
                        <div><!----></div>
                        <!---->
                      </div>
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          ...
                          alt="156" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">156</span>
                      </div>
