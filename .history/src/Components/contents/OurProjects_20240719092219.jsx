    ...
    <section class="my-8">
      <div class="md:container px-4 m-auto">
        ...
        <div class="flex items-center justify-center pb-5 lg:pb-6">
          <span class="text-lg md:text-xl font-header lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer border-b-2 font-bold">
            المتاحة
          </span>
          <span class="text-lg md:text-xl font-header lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer">
            القادمة
          </span>
          <span class="text-lg md:text-xl font-header lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer">
            للإيجار
