        ...
        <div className="container m-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 px-4 text-white text-center">
            <div>
              ...
              />
              <span className="block font-acumin-pro text-lg pt-3 lg:pt-4 lg:text-2xl">
                2,000,000
              </span>
            ...
            >
              <li
                ...
                <div className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden mx-4 w-full h-full">
                  ...
                  <h2 className="h-[64px] overflow-hidden mx-0 mt-0 mb-4 py-2 px-3 text-lg text-left rtl:text-right leading-8 text-black dark:text-white font-ge-dinar-medium">
                    <a href="https://almajdiah.com/blog/22" className="block">
                      الماجدية ريزدنس تستحوذ على مجموعة أراضي بمساحة 17,840 متر
                      مربع بقيمة 190 مليون ريال
                    </a>
                  </h2>
                </div>
              </li>
              <li
                ...
                <div className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden mx-4 w-full h-full">
                  ...
                  <h2 className="h-[64px] overflow-hidden mx-0 mt-0 mb-4 py-2 px-3 text-lg text-left rtl:text-right leading-8 text-black dark:text-white font-ge-dinar-medium">
                    <a href="https://almajdiah.com/blog/19" className="block">
                      الماجدية ريزيدنس تتنازل عن أتعاب مشروع الماجدية 123 لصالح
                      جمعية "تعلَّم" لتحفيظ القرآن الكريم
                    </a>
                  </h2>
                </div>
              </li>
              <li
                ...
                <div className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden mx-4 w-full h-full">
                  ...
                  <h2 className="h-[64px] overflow-hidden mx-0 mt-0 mb-4 py-2 px-3 text-lg text-left rtl:text-right leading-8 text-black dark:text-white font-ge-dinar-medium">
                    <a href="https://almajdiah.com/blog/18" className="block">
                      الماجدية ريزدنس الراعي الماسي لمعرض مسكن العقاري 2023 في
                      الرياض
                    </a>
                  </h2>
                </div>
