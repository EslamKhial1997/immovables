            ...
            <div className="md:container px-4 m-auto">
              ...
              >
                <div className="hidden lg:grid lg:grid-cols-3 gap-3.5 my-4">
                  <div className="">
                    <label className="block"
                      ><span
                        className="block mb-1.5 text-lg text-secondary-700 dark:text-secondary-400 font-ge-dinar-medium"
                        >المنطقة</span
                      ><select
                        className="shadow-sm block w-full mt-1  py-2 lg:py-3 border border-secondary-200 focus:border-primary-500 focus:ring focus:ring-primary-500"
                      >
                  ...
                  <div className="">
                    <label className="block"
                      ><span
                        ...
                        >الحي</span
                      ><select
                        className="shadow-sm block w-full mt-1 shadow-sm py-2 lg:py-3 border border-secondary-200 focus:border-primary-500 focus:ring focus:ring-primary-500"
                      >
                        <option selected="">
                          - يرجى تحديد الإختيار -
                        </option></select
                ...
                >
                  <div className="col-span-full">
                    <div className="flex items-center justify-center pb-5 lg:pb-6">
                      <span
                        className="text-lg md:text-xl lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer border-b-2 font-bold"
                        >المتاحة</span
                      ><span
                        className="text-lg md:text-xl lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer"
                        >القادمة</span
                      >
                    </div>
                  </div>
                ...
                <div className="pb-8 my-2">
                  <div className="md:container px-4 m-auto">
                    <nav
                      className="max-w-2xl mx-auto text-center text-secondary-800 dark:text-secondary-100 font-acumin-pro"
                    >
                      <div
                        className="flex space-x-2 space-x-reverse justify-center pt-6"
                      >
                        <div>
                          <button
