...
import slide1 from "../../../assets/available/image6.jpg"
...
const Slider = () => {
  return (
       ...
       <Swiper
        ...
        className="mySwiper"
      >
        <SwiperSlide><img className='w-100 h-100 object-cover' src={../../../assets/available/image8.jpg} alt="" srcSet="Slider" /></SwiperSlide>
