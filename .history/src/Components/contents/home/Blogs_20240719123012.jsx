         ...
         centeredSlides
          ...
          >
            <SwiperSlide>
              ...
              >
                <div className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden  w-full h-max">
                  ...
                  <h2 className="h-[80px] overflow-hidden mx-0 mt-0 mb-4 py-2 px-3 text-lg text-left rtl:text-right leading-8 text-black dark:text-white font-ge-dinar-medium">
                    <a href="https://almajdiah.com/blog/18" className="block">
