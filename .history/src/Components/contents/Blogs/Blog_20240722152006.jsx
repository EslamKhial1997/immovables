...
const Blog = () => {
    return (
        <div>
          ...
          <div>
            <div
              className="leading-5 bg-secondary-50 dark:bg-secondary-800 bg-cover bg-no-repeat"
            >
                  ...
                  <div className="flex flex-wrap -mx-4 mt-0 text-neutral-500">
                    <div className="flex-none px-4 mt-0 w-full max-w-full">
                      <div className="relative text-center">
                        <h1
                          className="mx-0 mt-0 mb-2 font-header text-3xl font-ge-dinar-medium text-black md:text-4xl lg:text-6xl"
                        ...
                        <div>
                          <nav className="">
                            <ul className="p-0 m-0">
                              ...
                              >
                                <span
                                  className="text-lg leading-7 text-black font-header"
                                  >المدونة</span
                                >
                              </li>
                            </ul>
            ...
            <div className="md:container px-4 m-auto">
              <div
                className="mt-0 relative bg-white lg:bg-transparent xl:bg-white dark:bg-secondary-900 lg:-mt-28 py-4 md:px-8 lg:px-1 xl:px-8 mb-8 rounded-lg"
              >
                <div
                  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-3"
                >
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    ...
                    >
                      <a href="https://almajdiah.com/blog/22" className="block"
                        >الموافقة ريزدنس تستحوذ على مجموعة أراضي بمساحة 17,840
                  ...
                  >
                    ...
                    >
                      <a href="https://almajdiah.com/blog/19" className="block"
                        >الموافقة ريزيدنس تتنازل عن أتعاب مشروع الموافقة 123
                  ...
                  >
                    ...
                    >
                      <a href="https://almajdiah.com/blog/18" className="block"
                        >الموافقة ريزدنس الراعي الماسي لمعرض مسكن العقاري 2023
                        في الرياض</a
                      >
                    </h2>
                  </div>
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/17" className="block"
                      ><img
                        src="https://minio.almajdiah.sa:9000/etmaam-public/posts/images/J0e8IP0qgUH6xA2aVF9zQdQk1HLD3XG4rl7SnDcb.jpg"
                        alt="blog"
                        data-v-2d36321d=""
                        className="w-full align-middle aspect-[5/3] object-cover"
                    /></a>
                    ...
                    >
                      <a href="https://almajdiah.com/blog/17" className="block"
                        >"الموافقة ريزدنس" تنظم ورشة عمل داخلية بِالتعاون مع
                        Foster + Partner" في مدينة لندن</a
                      >
                    </h2>
                  </div>
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/15" className="block"
                      ><img
                        src="https://minio.almajdiah.sa:9000/etmaam-public/posts/images/6bf1SvLsh1AzYI52gR2Vl4g1kKYw5XCQYuWkv0bx.jpg"
                        alt="blog"
                        data-v-2d36321d=""
                        className="w-full align-middle aspect-[5/3] object-cover"
                    /></a>
                    ...
                    >
                      <a href="https://almajdiah.com/blog/15" className="block"
                        >تدشين مشروع الموافقة 125 في حي الملك سلمان بالرياض</a
                      >
                    </h2>
                  </div>
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/14" className="block"
                      ><img
                        src="https://minio.almajdiah.sa:9000/etmaam-public/posts/images/49lS2bFYOzJfFUqO9lmIj5DKf3SHBivltE3ZY9tK.jpg"
                        alt="blog"
                        data-v-2d36321d=""
                        className="w-full align-middle aspect-[5/3] object-cover"
                    /></a>
                    ...
                    >
                      <a href="https://almajdiah.com/blog/14" className="block"
                        >الموافقة ريزدنس تحصد جائزة أفضل صندوق عقاري لعام
                        2021</a
                      >
                    </h2>
                  </div>
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/12" className="block"
                      ><img
                        src="https://minio.almajdiah.sa:9000/etmaam-public/posts/images/FxLyeKt5zhZVejNeC3Ym9MHNDkVZmgQjRVuWoyib.jpg"
                        alt="blog"
                        data-v-2d36321d=""
                        className="w-full align-middle aspect-[5/3] object-cover"
                    /></a>
                    ...
                    >
                      <a href="https://almajdiah.com/blog/12" className="block"
                        >بيع مشروعنا السكني الأول في مانشستر بالكامل</a
                      >
                    </h2>
                  </div>
                </div>
