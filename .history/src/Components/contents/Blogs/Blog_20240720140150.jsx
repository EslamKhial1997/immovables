          ...
          <div>
            ...
            <div class="md:container px-4 m-auto">
              ...
              >
                ...
                >
                  <div
                    class="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                  ...
                  <div
                    class="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/17" class="block"
                      ><img
                  ...
                  <div
                    class="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/15" class="block"
                      ><img
                  ...
                  <div
                    class="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/14" class="block"
                      ><img
                  ...
                  <div
                    class="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden"
                  >
                    <a href="https://almajdiah.com/blog/12" class="block"
                      ><img
