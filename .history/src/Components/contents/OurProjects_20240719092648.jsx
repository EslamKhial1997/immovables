                  ...
                  <a class="block mb-2 text-secondary-500" href="https://almajdiah.com/projects/192">
                    <div class="rounded-tl-lg rounded-tr-lg cursor-pointer relative">
                      <img
                        ...
                        alt="الماجدية ريزدنس 155" class="w-full aspect-[5/3] text-blue-700 align-middle object-cover" />
                      <div><!----><!----></div>
                      <!---->
                    </div>
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          ...
                          alt="155" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">155</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a class="block mb-2 text-secondary-500" href="https://almajdiah.com/projects/183">
                    <div class="rounded-tl-lg rounded-tr-lg cursor-pointer relative">
                      <img
                        ...
                        alt="الماجدية ريزدنس 147" class="w-full aspect-[5/3] text-blue-700 align-middle object-cover" />
                      <div>
                        <div><!----></div>
                        <!---->
                      </div>
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="147" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">147</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
                  ...
                  <a class="block mb-2 text-secondary-500" href="https://almajdiah.com/projects/179">
                    <div class="rounded-tl-lg rounded-tr-lg cursor-pointer relative">
                      <img
                        ...
                        class="w-full aspect-[5/3] text-blue-700 align-middle object-cover" /><img
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="146" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">146</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
                  ...
                  <a class="block mb-2 text-secondary-500" href="https://almajdiah.com/projects/176">
                    <div class="rounded-tl-lg rounded-tr-lg cursor-pointer relative">
                      <img
                        ...
                        alt="الماجدية ريزدنس 144" class="w-full aspect-[5/3] text-blue-700 align-middle object-cover" />
                      <div>
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="144" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">144</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="143" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">143</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
                  ...
                  <a class="block mb-2 text-secondary-500" href="https://almajdiah.com/projects/172">
                    <div class="rounded-tl-lg rounded-tr-lg cursor-pointer relative">
                      <img
                        ...
                        alt="الماجدية ريزدنس 140" class="w-full aspect-[5/3] text-blue-700 align-middle object-cover" />
                      <div>
                        <img src="https://almajdiah.com/images/project-state-on_map-ar.png" alt="project sale on map"
                          class="absolute -left-2 -top-2 w-36" /><!---->
                      </div>
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="140" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">140</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="139 C" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">139
                          C</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="138" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">138</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
                  ...
                  <a class="block mb-2 text-secondary-500" href="https://almajdiah.com/projects/163">
                    <div class="rounded-tl-lg rounded-tr-lg cursor-pointer relative">
                      <img
                        ...
                        alt="الماجدية ريزدنس 132" class="w-full aspect-[5/3] text-blue-700 align-middle object-cover" />
                      <div>
                        <div><!----></div>
                        <!---->
                      </div>
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="132" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">132</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
                    ...
                    <div class="py-2 px-3 flex justify-between items-center">
                      <div class="flex content-center items-center">
                        <img src="https://almajdiah.com/images/project-category-1-ar.png"
                          class="w-12 xs:w-12 lg:w-14 xl:w-20 inline-block dark:invert dark:brightness-0"
                          alt="129" /><span
                          class="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2">129</span>
                      </div>
                      <div class="text-primary-500">
                        <svg class="w-3 xl:w-6 xl:h-6 inline-block" xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" width="10.799" height="17.247"
