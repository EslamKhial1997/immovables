...
function App() {
  ...
  >
    <div className="min-h-screen bg-secondary-50 dark:bg-gray-900">
        ...
        <div className="md:container px-4 m-auto">
          <div className="flex justify-between h-16 lg:h-20">
            <div className="flex grow">
              ...
              <div
                className="hidden grow flex-shrink lg:flex space-x-reverse space-x-4 mx-8"
              >
                <a
              ...
              <div
                className="hidden grow lg:flex justify-end items-center rtl:space-x-reverse space-x-4 text-primary-500 relative"
              >
                <a
                  className="p-1 leading-[10px]"
                  ...
                  مقارنة</a
                ><a
                  className="p-1 text-center leading-[10px]"
                  ...
                  ><br />
                  دخول</a
                ><button className="items-center font-medium">
                  <svg
                    className="svg-inline--fa fa-globe text-xl mx-1 mt-[12px] leading-[10px]"
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                    data-icon="globe"
            ...
            <div className="-mr-2 flex-shrink-0 flex items-center lg:hidden">
              <button
        ...
        <div className="hidden lg:hidden">
          <div className="pt-2 pb-3 space-y-1 px-3">
            ...
            ><a
              ...
              >تسجيل الدخول</a
            ><a
              className="flex items-center block py-3 px-3 lg:inline-flex items-center lg:py-1 text-lg font-ge-dinar-medium leading-5 text-white transition flex items-center"
              href=""
              ><div className="block">
                <svg
        ...
        <section className="my-8">
          <div className="md:container px-4 m-auto">
            <div className="text-center mb-3 lg:mb-5">
              ...
              <h1
                className="inline-block text-xl font-header md:text-2xl px-1.5 lg:text-4xl font-ge-dinar-medium leading-none text-black dark:text-white"
              >
                مشاريعنا
              </h1>
            </div>
            <div className="flex items-center justify-center pb-5 lg:pb-6">
              <span
                className="text-lg md:text-xl font-header lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer border-b-2 font-bold"
                >المتاحة</span
              ><span
                className="text-lg md:text-xl font-header lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer"
                >القادمة</span
              ><span
                className="text-lg md:text-xl font-header lg:text-2xl mx-3 pb-1 lg:pb-2 border-black cursor-pointer"
                >للإيجار</span
              ...
              >
                <div className="group shadow bg-white overflow-hidden rounded-lg">
                  <a
                    ...
                    ><div
                      className="rounded-tl-lg rounded-tr-lg cursor-pointer relative"
                    >
                      <img
                    ...
                    <div className="py-2 px-3 flex justify-between items-center">
                      <div className="flex content-center items-center">
                        <img
                          ...
                          alt="156"
                        /><span
                          className="inline-block !font-analogue text-black dark:text-white text-2xl xs:text-3xl lg:text-[1.7rem] lg:leading-[1.3] xl:text-4xl px-2"
                          >156</span
                        >
                      </div>
                      <div className="text-primary-500">
                        ...
                        ><span
                          className="text-sm font lg:text-base px-0.5 font-ge-dinar-medium"
                          >الرياض - الندى</span
                        >
                      </div>
                    </div></a
          ...
          >
            ...
            >
              <div className="leaflet-pane leaflet-tile-pane">
                <div className="leaflet-layer" style="z-index: 1; opacity: 1">
                  <div
          ...
          >
            <div className="py-1">
              ...
              /><img
                ...
                alt="الكل"
              /><span className="inline-block px-2 cursor-pointer">الكل</span>
            </div>
            <div className="py-1">
              <input
                type="radio"
              ...
              /><img
                ...
                className="inline-block h-6 mx-2"
                alt="للبيع"
              /><span className="inline-block px-2 cursor-pointer">متاحة</span>
            </div>
            <div className="py-1">
              <input
                type="radio"
              ...
              /><img
                ...
                className="inline-block h-6 mx-2"
                alt="قريبا للبيع"
              /><span className="inline-block px-2 cursor-pointer">قادمة</span>
            </div>
            <div className="py-1">
              <input
                type="radio"
              ...
              /><img
                ...
                className="inline-block h-6 mx-2"
                alt="مباع"
              /><span className="inline-block px-2 cursor-pointer">مباعة</span>
            </div>
          </div>
        </div>
        <section className="bg-black mb-8 py-8 lg:py-16">
          <div className="container m-auto">
            <div className="text-center pb-10">
              <h2
                className="text-white text-2xl md:text-3xl lg:text-4xl font-ge-dinar-medium pb-2"
              >
                إنــجـــازاتـنــــا
              </h2>
              <img
                src="https://almajdiah.com/images/divid-bg.png"
                className="h-3 w-36 lg:h-4 lg:w-44 inline-block m-auto"
                alt="divid"
              />
            </div>
            <div
              className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 px-4 text-white text-center"
            >
              <div>
                <img
                  src="https://minio.almajdiah.sa:9000/etmaam-public/site/images/4kf65Z9fTnQsijmhK7MDjYf7lj2h7apWCmNOfVCR.png"
                  className="w-16 lg:w-24 m-auto"
                  alt="متر مربع تم تطويره"
                /><span
                  className="block font-acumin-pro text-lg pt-3 lg:pt-4 lg:text-2xl"
                  >2,000,000</span
              ...
              <div>
                ...
                /><span
                  className="block font-acumin-pro text-lg pt-3 lg:pt-4 lg:text-2xl"
                  >1000+</span
                ><span className="block text-lg lg:text-xl">مبنى تم إنشاؤه</span>
              </div>
              <div>
                <img
                ...
                /><span
                  className="block font-acumin-pro text-lg pt-3 lg:pt-4 lg:text-2xl"
                  >15,000+</span
                ><span className="block text-lg lg:text-xl">وحدة سكنية</span>
              </div>
            </div>
          </div>
        </section>
        <div className="my-8 lg:container m-auto">
          <div className="text-center mb-3 lg:mb-5">
            <svg
              className="inline-block w-6 h-6 lg:w-10 lg:h-10"
              xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <div className="carousel__viewport">
              ...
              >
                ...
                >
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden mx-4 w-full h-full"
                  >
                    <a href="https://almajdiah.com/blog/22" className="block"
                      ><img
                    ...
                    /></a>
                    <div
                      className="flex px-2 pt-3 text-primary-500 space-x-2 space-x-reverse"
                    >
                      <svg
                    ...
                    <h2
                      className="h-[64px] overflow-hidden mx-0 mt-0 mb-4 py-2 px-3 text-lg text-left rtl:text-right leading-8 text-black dark:text-white font-ge-dinar-medium"
                    >
                      <a href="https://almajdiah.com/blog/22" className="block"
                ...
                >
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden mx-4 w-full h-full"
                  >
                    <a href="https://almajdiah.com/blog/19" className="block"
                      ><img
                ...
                >
                  <div
                    className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden mx-4 w-full h-full"
                  >
                    <a href="https://almajdiah.com/blog/18" className="block"
                      ><img
                ...
                <li
                  className="carousel__slide carousel__slide--prev"
                  aria-hidden="true"
                  style="width: 414.4px"
                >
                  <div
                ...
                <li
                  className="carousel__slide carousel_slide--clone carousel__slide--next"
                  aria-hidden="true"
                  style="width: 414.4px"
                >
                  <div
      ...
      <footer
        className="bg-black bg-logo bg-[length:200px] bg-left-bottom bg-repeat-x font-content"
      >
        <div className="mx-auto max-w-screen-xl py-8">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-6 md:mb-0">
              <a className="flex items-center" href="https://almajdiah.com/"
                ><img
                  src="https://minio.almajdiah.sa:9000/etmaam-public/site/images/VmyJSVcSg346Kz5TFlSLDFnZtTgzbF5hdcZnS21G.png"
                  className="mr-3 h-16 invert brightness-0"
                  alt=" Logo"
              /></a>
              <p className="max-w-[440px] text-sm text-secondary-100 p-3 block">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 px-4">
              <div>
                <h2
                  className="mb-2 lg:mb-6 text-base lg:text-xl font-ge-dinar-medium text-secondary-100"
                >
                  روابط هامة
                </h2>
              ...
              <div>
                ...
                <ul>
                  <li className="text-secondary-200 text-sm font-acumin-pro">
              ...
              <div className="col-span-full lg:col-span-1">
                ...
                <div
                  className="flex w-full rtl:space-x-reverse space-x-3 text-secondary-200"
                >
        ...
        <div
          className="sm:flex sm:items-center sm:justify-between bg-black bg-waves"
        >
          <div className="container m-auto text-center py-4">
            <span className="text-sm text-secondary-200"
              ...
              <a className="hover:underline" href="https://almajdiah.com/"
                >الماجدية ريزدنس</a
              >.
            </span>
          </div>
